...
import 'package:gadeer/modules/register/bloc/forms/association_register_form_bloc.dart';
...
class AssociationFormWidget extends StatefulWidget {
  final RegisterBloc? registerBloc;
  AssociationFormWidget(this.registerBloc);

  @override
  State<AssociationFormWidget> createState() => _AssociationFormWidgetState();
}

class _AssociationFormWidgetState extends State<AssociationFormWidget> {
  AssociationFormBloc? _formBloc;
  @override
  void initState() {
    _formBloc = AssociationFormBloc();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return FormBlocListener<AssociationFormBloc, LoginResponse, Object>(
        formBloc: _formBloc,
        onFailure: _formBloc!.onFailure,
        onSuccess: _formBloc!.onSuccess,
        onSubmitting: (_, __) => Notifications.showLoading(),
        child: BlocConsumer<AssociationFormBloc, FormBlocState>(
          bloc: _formBloc,
