...
class AllConsultantPage extends StatefulWidget {
  final List<int?> cats;
  AllConsultantPage(this.cats);
  @override
  _AllConsultantPageState createState() => _AllConsultantPageState();
}

class _AllConsultantPageState extends State<AllConsultantPage> {
