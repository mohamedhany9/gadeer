...
class SelectableConsultantItemWidget extends StatelessWidget {
  const SelectableConsultantItemWidget(this.consultant, this.select,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: InkWell(
        onTap: () async {
          var consultx = await Get.to(ShowProfilePage(
            consultant,
            isSelectable: true,
          ));
