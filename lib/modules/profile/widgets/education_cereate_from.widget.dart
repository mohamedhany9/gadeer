...
import 'package:gadeer/modules/profile/bloc/forms/education_create_form.bloc.dart';

class EducationCreateFormWidget extends StatefulWidget {
  EducationCreateFormWidget({Key? key}) : super(key: key);

  @override
  State<EducationCreateFormWidget> createState() =>
      _EducationCreateFormWidgetState();
}

class _EducationCreateFormWidgetState extends State<EducationCreateFormWidget> {
  EducationCreateFormBloc? formBloc;

  @override
  void initState() {
    formBloc=EducationCreateFormBloc();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return FormBlocListener<EducationCreateFormBloc, ProfileResponse, Object>(
      formBloc: formBloc,
